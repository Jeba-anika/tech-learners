            ...
            <div className="navbar bg-base-100">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                            <li><Link className="btn btn-ghost normal-case text-xl lg:hidden" to='/'>Tech Learners</Link></li>
                    ...
                    <Link className="btn btn-ghost normal-case text-xl lg:block md:block sm:hidden hidden" to='/'>Tech Learners</Link>
                ...
                <div className="navbar-center hidden lg:flex">
                    <ul className="menu menu-horizontal p-0">
                        ...
                        <li className='mr-8'><Link to='/faq'>FAQ</Link></li>
                ...
                <div className="navbar-end">
                    {
                        user?.uid ? <>
                            ...
                            <button onClick={handleLogOut} className='btn btn-outline btn-warning ml-4'>Logout</button>
                        </>
