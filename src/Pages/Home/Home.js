...
const Home = () => {
    return (
        <div>
            <div className='lg:mr-20 lg:ml-20 md:mr-20 md:ml-20 sm:mr-5 sm:ml-5 mr-5 ml-5 mt-10 border-4 border-yellow-200 home-background rounded-xl '>
                 <div className='grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 grid-cols-1 gap-4'>
                    <div className='lg:p-12 md:p-12 sm:p-2 p-2'>
